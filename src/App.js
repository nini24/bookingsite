...
function App() {
  ...
  return (
    <div className="App font-['Gilroy']">
      ...
      <button onClick={toggle} className='font-bold px-8 py-4 bg-black text-white mt-16 hover:outline-none hover:bg-slate-900'>Book a session</button>
      ...
      <div className='pt-4 grid grid-cols-3'>
        ...
        <div className=''><img className='mt-10 lg:w-40' src={imagethre} /></div>
